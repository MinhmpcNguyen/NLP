...
FAISS_INDEX_PATH = (
    "/Users/Yuki/NLP/no_api/save_local_db/sem_len_cluster_sem/rechunked_index.faiss"
)
METADATA_PATH = (
    "/Users/Yuki/NLP/no_api/save_local_db/sem_len_cluster_sem/rechunked_metadata.json"
)
TOP_K = 100
# ================
...
# ✅ Hybrid search
def hybrid_search_dynamic(query: str, top_k: int = TOP_K, final_k: int = 5):
